    ...
    if merchant_pos.blank?
      ...
      #private_pos = CertifiedAgent.where("sub_certified_agent_id = '#{params[:sub_agent]}' ").first rescue "null"
        ...
        if is_a_number?(transaction_amount)
          ...
          @url = "#{Parameter.first.paymoney_wallet_url}/PAYMONEY_WALLET/rest/Remonte/#{@token}/#{merchant_pos.token}/rKQNyFfn/#{transaction_amount}/#{fee}/0/#{transaction_id}/null"
    ...
    if merchant_pos.blank?
      ...
      #private_pos = CertifiedAgent.where("sub_certified_agent_id = '#{params[:sub_agent]}' ").first rescue "null"
        ...
        if is_a_number?(transaction_amount)
          ...
          if @has_rib
            @url = "#{Parameter.first.paymoney_wallet_url}/PAYMONEY_WALLET/rest/Remonte_avec_rib/#{@token}/#{merchant_pos.token}/rKQNyFfn/#{transaction_amount}/#{fee}/0/#{transaction_id}/null"
          else
            @url = "#{Parameter.first.paymoney_wallet_url}/PAYMONEY_WALLET/rest/Remonte_sans_rib/#{@token}/#{merchant_pos.token}/rKQNyFfn/#{transaction_amount}/#{fee}/0/#{transaction_id}/null"
          end
